                            ...
                            <div
                                ...
                                <div class="flex self-stretch justify-start items-start flex-row gap-6">
                                    ...
                                    <div class="flex flex-1 justify-start items-start flex-col gap-2.5">
                                        ...
                                        <!-- Google Maps Section -->
                                        <div v-if="customer?.address" class="flex self-stretch justify-start items-start flex-col gap-[5px]">
                                            <div class="flex self-stretch justify-start items-start flex-row gap-[5px]">
                                                <p class="text-[#000000] text-sm font-medium leading-6">
                                                    Location Map
                                                </p>
...
const referrer = ref('/customers/all')
...
const getFullAddress = () => {
    if (!customer.value) return 'Tangerang, Indonesia'
...
onMounted(async () => {
    try {
        if(document.referrer.includes('/customers/restore')) {
            referrer.value = '/customers/restore'
        } else if(document.referrer.includes('/customers/all')){
            referrer.value = '/customers/all'
        } else if (localStorage.getItem('customerReferrer')){
            referrer.value = localStorage.getItem('customerReferrer')
        }

        localStorage.setItem('customerReferrer', referrer.value)

...
class UpdateSaleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "sale_details.*.id" => ['required', 'exists:sale_details,id'],
            "sale_details.*.product_id" => ["sometimes", "integer", "exists:products,id"],
...
//            "sale_details.*.unit_price" => ["sometimes", "numeric", "min:0"],
            ...
            "sale_payments.*.due_date" => ["sometimes", "nullable", "date"],
            ...
            'shipments.*.id' => ['sometimes', 'exists:shipments,id'],
            "shipments.*.courier_id" => ["sometimes", "integer", "exists:couriers,id"],
